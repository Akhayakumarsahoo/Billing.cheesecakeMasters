...
export function AdminSettlementFormClient({
  ...
  // Reset form inputs when date changes (creation mode only)
  useEffect(() => {
    if (!isEdit) {
      setClosingCashInput("");
      setActualCash("");
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-2">
                ...
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <Input
                    ...
                    min={minDateStr}
                    max={maxDateStr}
                    className="font-mono text-sm h-10 bg-white border-[var(--border-default)] disabled:bg-[var(--bg-surface-raised)]"
                  />
                </div>
                ...
                <div className="space-y-2 sm:col-span-2">
                  <Label htmlFor="closingCash" className="text-sm font-medium text-[var(--text-primary)]">
